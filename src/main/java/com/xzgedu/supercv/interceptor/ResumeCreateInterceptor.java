...
@Slf4j
@Component
public class ResumeCreateInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (vipService.permitResumeCreate(selfUid) && vipService.decreaseResumeCreateLeftNum(selfUid)) {
            return true;
        }

        //没有权限
        log.warn("No permission to create resume by uid={}", selfUid);
